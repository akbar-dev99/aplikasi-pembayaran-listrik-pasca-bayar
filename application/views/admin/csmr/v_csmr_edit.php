...
$nama_val = $customer->nama_pelanggan;
$usr_val = $customer->username;
$no_kwh = $customer->nomor_kwh;
$alamat = $customer->alamat;
$tarif =  $customer->id_tarif;
        ...
        <div class="card">
          <div class="card-body ">
            <div class="m-sm-4">
              ...
              <form action="<?php echo base_url('administrator/pelanggan/ubah/' . $customer->id_pelanggan); ?>" method="post">
                <div class="row">
